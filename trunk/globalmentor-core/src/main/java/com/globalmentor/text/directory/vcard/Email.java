...
public class Email
{
	...
	public final static int NO_EMAIL_TYPE = 0; //TODO switch to using enums and enum sets
	...
	/**
	 * @return The email addressing type; defaults to <code>INTERNET_EMAIL_TYPE</code>.
	 */
	 ...
	 * @param emailType The email addressing type, one or more of the <code>XXX_EMAIL_TYPE</code> constants ORed together.
	 */
	public void setEmailType(final int emailType)
	{
	 ...
	 * @param emailType The email addressing type, one of the <code>XXX_EMAIL_TYPE</code> constants.
	 */
	...
	/**
	 * The string for separating the components of the string representation of the EMAIL type.
	 */
	 ...
	 * @param emailType The intended use, one or more of the <code>XXX_EMAIL_TYPE</code> constants ORed together.
	 */
