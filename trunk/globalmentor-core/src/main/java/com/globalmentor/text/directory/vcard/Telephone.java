...
public class Telephone extends TelephoneNumber
{
	...
	public final static int NO_TELEPHONE_TYPE = 0; //TODO convert to enums and enum sets
	...
	/**
	 * @return The intended use; defaults to <code>VOICE_TELEPHONE_TYPE</code>.
	 */
	 ...
	 * @param telephoneType The intended use, one or more of the <code>XXX_TELEPHONE_TYPE</code> constants ORed together.
	 */
	...
	/**
	 * Constructs a telephone with the default type by parsing the given string. Expects the country code to begin with '+' and accepts code field delimiters of
	 * '-' and ' '.
	...
	/**
	 * The string for separating the components of the string representation of the telephone type.
	 */
